...
import {PictureList} from "react-native-image-kit";
...
let pictureList = new PictureList(photoFolder);
...
export default {
    ...
    buttonList : function(list, styles={}, arg=null) {
        return list.map( (v, i) => {
            ...
            v.style = v.style ? Object.assign(v.style, styles.button) : styles.button;
            return this.button(v);
        });
    },
    ...
    // FooterTab
    tabBar: {
        textColor: platform === "ios" ? "#737373" : "#bfc6ea",
        textSize: platform === "ios" ? 14 : 11,
        activeTab: platform === "ios" ? "#007aff" : "#fff",
        subActiveTextColor: "#007aff",
        activeTextColor: platform === "ios" ? "#2874F0" : "#fff",
        activeBgColor: platform === "ios" ? "#cde1f9" : "#3F51B5",
    },
